...
#Експлуатаційне навантаження від ожеледі:
g_mp = g_p*gamma_fG[klass_bezv[U]]
#Експлуатаційне навантаження від відтру:
...
C_h_dict = {1:{5:0.9, 10:1.2, 20:1.35, 40:1.6, 60:1.75},\
