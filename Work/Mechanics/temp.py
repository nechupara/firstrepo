...
def kubik_uravn(a, b, c, d):
    ...
    if discrim > 0:
        ...
        y2 = complex(-0.5*(rootodd(-q/2 + discrim**(1/2), 3) + rootodd(-q/2 - discrim**(1/2), 3)),
                     3**(1/2)/2*(rootodd(-q/2 + discrim**(1/2), 3) - rootodd(-q/2 - discrim**(1/2), 3)))
...
# if Q > 0:
#     alfa0 = -q/2 + Q ** (1 / 2)
#     alfa = rootodd(alfa0, 3)
#     # if alfa0 < 0:
#     #     alfa = -1*abs(alfa0)**(1/3)
#     # else:
#     #     alfa = alfa0 ** (1 / 3)
#     betta0 = -q/2 - Q ** (1 / 2)
#     betta = rootodd(betta0, 3)
#     # if betta0 < 0:
#     #     betta = -1*abs(betta0)**(1/3)
#     # else:
#     #     betta = betta0 ** (1 / 3)
#     y1 = alfa + betta
#     x = y1 - b/(3*a)
